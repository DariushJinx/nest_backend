...
export class BlogCategoryService {
  ...
  async getListOfCategories(
    ...
    const queryBuilder = this.categoryRepository
      ...
      .leftJoinAndSelect('blogCategory.register', 'register');
    ...
    if (query.register) {
      ...
      queryBuilder.andWhere('blogCategory.registerId = :id', {
        id: register.id,
      });
    }
    ...
    queryBuilder.orderBy('blogCategory.createdAt', 'DESC');

    const blogCategoriesCount = await queryBuilder.getCount();
    const blogCategories = await queryBuilder.getMany();
  ...
  async reIndexTreeCategory(admin: AdminEntity) {
    ...
    const queryBuilder =
      this.categoryRepository.createQueryBuilder('blogCategory');

    queryBuilder.orderBy('blogCategory.id', 'DESC');
